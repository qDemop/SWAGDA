            ...
            <Stack mt={10} >
              <Field.Root mb={3} invalid={!!errors.email}>
                <Box pos="relative" w="full">
                  ...
                  />
                  <Field.Label css={floatingStyles}>Correo Electronico</Field.Label>
                </Box>
              ...
              <Field.Root mb={3} invalid={!!errors.confirmarPassword}>
                <Box pos="relative" w="full">
                  <Input
                  ...
                  />
                  <Field.Label css={floatingStyles}>Confirmar Contraseña</Field.Label>
                  <Box
                  as="button"
                  type="button"
                  position="absolute"
                ...
                <FieldErrorText color="#FF6B6B">{errors.confirmarPassword?.message}</FieldErrorText>
              </Field.Root>
